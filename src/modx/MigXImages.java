...
public class MigXImages {
    public static void main(String[] args) {
        ...
        ese.initialize("http://folk-kamen.lovegrizzly.ml/manager/?a=resource/update&id=126");
        ese.pageLoaded();
        ese.click(By.id("modx-resource-tabs__modx-panel-resource-tv"));
        ese.click(By.id("modx-resource-vtabs__ext-comp-1041"));
        for (String anArr : arr) {
            ese.click(By.xpath("//button[text()='Добавить изображение']"));
